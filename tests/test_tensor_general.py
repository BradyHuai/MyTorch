...
backend_tests = [pytest.param("fast", marks=pytest.mark.mm)]

matmul_tests = [pytest.param("fast", marks=pytest.mark.mm2)]


if numba.cuda.is_available():
    backend_tests.append(pytest.param("cuda", marks=pytest.mark.mm))

    matmul_tests.append(pytest.param("cuda", marks=pytest.mark.mm))
